...
function getAccessDeniedMessage(reason) {
  switch (reason) {
    ...
    case 'deposit_pending':
      return "The corporate partner's deposit is pending confirmation. You will gain access to the project workspace once the deposit is confirmed by Campus2Career.";
    case 'unauthorized':

...
html = html.replace('<!--!title-->', '<title>Proveground | Where Campus Meets Career</title>');

// Replace meta placeholder
html = html.replace('<!--!meta-->', [
  '<meta name="description" content="Proveground connects students with companies for real-world project experience.">',
].join('\n'));

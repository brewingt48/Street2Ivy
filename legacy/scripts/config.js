...
${chalk.dim(
  'The marketplace name is needed for the marketplace texts. If not set through environment variables, the name defaults to "Street2Ivy" (set in src/config/configDefault.js)'
)}
`,

...
const chatMessages = [
  ...
  {
    type: 'coach' as const,
    text: 'Let\u2019s get you ready. C-suite audiences care about three things: bottom-line impact, risk profile, and timeline. Let\u2019s restructure your deck around those pillars and do a practice run.',
  },
  {
    type: 'user' as const,
    text: 'That makes sense. Can we start with the opening?',
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <div>
            ...
            <motion.h2
              ...
              className="font-display text-4xl sm:text-5xl text-[#1a1a2e] tracking-wide leading-[1.05] mb-6"
            >
              If AI is transforming the market, it should transform how students prepare.
            </motion.h2>
            ...
            >
              Proveground&apos;s AI coaching gives every student personalized, on-demand career
              guidance &mdash; from interview prep to project strategy to professional communication.
              Not a chatbot. A coach that meets students where they are and accelerates where
              they&apos;re going.
            </motion.p>
          ...
          <motion.div
            ...
            className="bg-[#FAFAF7] rounded-2xl border border-gray-200 p-6 md:p-8 shadow-sm"
          >
            {/* Chat header */}
            <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-200">
              ...
              <div>
                <p className="text-sm font-semibold text-[#1a1a2e]">Proveground AI Coach</p>

...
const pillars = [
  {
    ...
    body: 'The professional world is evolving fast. The skills that matter most now are the ones built through real experience, not just coursework.',
  },
  {
    icon: Zap,
    ...
    body: 'Real work builds what no algorithm can replicate \u2014 judgment, collaboration, and the ability to lead when it counts.',
  },
  {
    icon: Users,
    label: 'The Advantage',
  ...
  },
  {
    ...
    label: 'The Platform',
    stat: '1',
    statLabel: 'place to prove what you\u2019re made of',
    body: 'Proveground brings students, alumni, and programs together \u2014 so talent is recognized, opportunities are earned, and potential becomes proof.',
  },
];

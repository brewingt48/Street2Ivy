...
import {
  ...
  PROJECT_APPLICATION_PROCESS_NAME,
...
import { getStateDataForProjectApplicationProcess } from './TransactionPage.stateDataProjectApplication.js';
...
export const getStateData = (params, process) => {
  ...
  } else if (processName === PROJECT_APPLICATION_PROCESS_NAME) {
    return getStateDataForProjectApplicationProcess(params, processInfo());
  } else {
    return {};
  }
};

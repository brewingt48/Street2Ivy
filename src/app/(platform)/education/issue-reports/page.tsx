...
/**
 * Education Admin Issue Reports Page
 *
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500 dark:text-slate-400 mt-1">
          Review and manage issue reports submitted by students. Reports are categorized by type and can be tracked from open through investigation to resolution.
        </p>
      </div>

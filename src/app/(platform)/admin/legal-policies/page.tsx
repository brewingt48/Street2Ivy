...
/**
 * Admin Legal Policies — CRUD management for platform-wide legal policies
 *
 * Allows admin to create, edit, publish, reorder, and delete legal policies
 * (e.g. Privacy Policy, Terms of Service, Cookie Policy, etc.).
 * Published policies appear in the main homepage footer.
 */
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1">
            Create and manage legal policies that appear in the homepage footer
          </p>
        </div>
        <Button
          onClick={() => {
      ...
      {policies.length === 0 && !creating ? (
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-slate-500 text-lg font-medium">No legal policies yet</p>
            <p className="text-slate-400 text-sm mt-1">
              Create your first policy to display in the homepage footer.
            </p>
            <Button
              onClick={() => {
                setCreating(true);
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-3 mt-1">
                          <span className="text-xs font-mono text-slate-400">/legal/{policy.slug}</span>
      ...
      <Card>
        ...
        <CardContent>
          <ul className="text-sm text-slate-500 space-y-1">
            <li>Published policies automatically appear as links in the homepage footer.</li>
            <li>Each policy is accessible at <code className="text-xs bg-slate-100 dark:bg-slate-800 px-1 rounded">/legal/your-slug</code>.</li>
            <li>Tenant institutions can create their own policies that supplement these platform policies.</li>
            <li>Use the sort order field to control the order of links in the footer.</li>
          </ul>
        </CardContent>
      </Card>
    </div>

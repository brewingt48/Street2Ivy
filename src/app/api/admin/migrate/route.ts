    ...
    try {
      ...
      if (settingsCheck.length === 0) {
        await sql`
          ...
          VALUES ('platform_settings', '{"bookDemoUrl": "https://calendly.com/proveground-support/30min", "logoUrl": "", "hiddenSections": [], "aiCoachingEnabled": false, "heroCopy": {}, "problemCopy": {}, "ctaCopy": {}}'::jsonb)

    ...
    try {
      ...
      if (settingsCheck.length === 0) {
        await sql`
          ...
          VALUES ('platform_settings', '{"bookDemoUrl": "https://calendly.com/proveground-support/product-demo", "logoUrl": "", "hiddenSections": [], "aiCoachingEnabled": false, "heroCopy": {}, "problemCopy": {}, "ctaCopy": {}}'::jsonb)

/**
 * GET /api/admin/legal-policies/:id — Get a legal policy for editing
 * PUT /api/admin/legal-policies/:id — Update a legal policy
 * DELETE /api/admin/legal-policies/:id — Delete a legal policy
 */

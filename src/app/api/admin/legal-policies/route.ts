/**
 * GET /api/admin/legal-policies — List all platform legal policies
 * POST /api/admin/legal-policies — Create a new platform legal policy
 */
  ...
  try {
    ...
    const result = await sql`
      ...
      VALUES (
        ...
        ${data.sortOrder}, NULL, ${session.data.userId}, ${session.data.userId}
      )
    ...
    if (String(error).includes('idx_legal_policies_platform_slug')) {

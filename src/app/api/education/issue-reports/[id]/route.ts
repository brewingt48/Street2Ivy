/**
 * GET /api/education/issue-reports/:id — Get a single issue report
 * PATCH /api/education/issue-reports/:id — Update report status/resolution
 */
...
export async function GET(
  ...
  try {
    ...
    console.error('Issue report detail error:', error);

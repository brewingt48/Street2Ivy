...
// ---------------------------------------------------------------------------
// Shared AI Fairness & Bias Constraints
// ---------------------------------------------------------------------------

/**
 * Standard fairness constraint block injected into every AI prompt that
 * analyzes individual candidates or talent. This ensures the AI:
 *   1. Only uses explicitly submitted facts from candidates
 *   2. Only references stated job requirements
 *   3. Never infers or assumes demographics, background, or protected traits
 */
export const AI_FAIRNESS_CONSTRAINTS = [
  ``,
  `## CRITICAL — Fairness & Bias Constraints`,
  `You MUST follow these rules strictly:`,
  `1. BASE YOUR ANALYSIS ONLY ON FACTS: Use ONLY the information explicitly provided in the candidate's profile and the stated job/project requirements. Do not infer, assume, or speculate about any information not directly stated.`,
  `2. NO DEMOGRAPHIC ASSUMPTIONS: Do not make assumptions based on a candidate's name, university, location, age, gender, ethnicity, or any other demographic characteristic. These factors must NOT influence fit scores, assessments, or recommendations.`,
  `3. SKILLS AND REQUIREMENTS ONLY: Evaluate candidates solely on their explicitly stated skills, experience, coursework, and qualifications against the explicitly stated project/job requirements.`,
  `4. NO CULTURAL FIT JUDGMENTS: Do not assess "cultural fit" or make subjective personality judgments. Focus on objective skill alignment and stated qualifications.`,
  `5. EQUAL STANDARD: Apply the exact same evaluation criteria to every candidate regardless of their background. A skill gap is a skill gap; a matched skill is a matched skill.`,
  `6. ACKNOWLEDGE LIMITATIONS: If insufficient information is available to make a confident assessment, state that clearly rather than filling gaps with assumptions.`,
  `7. AI DISCLOSURE: This analysis is generated by AI and should be used as one input among many in decision-making. It is not a substitute for human judgment.`,
  ``,
].join('\n');

/**
 * Standard disclaimer text returned alongside AI analysis results.
 * Displayed to users on the frontend.
 */
export const AI_DISCLAIMER_TEXT =
  'This analysis is generated by AI based solely on the candidate\'s submitted profile information and the stated job requirements. AI can reflect biases present in data and language. Use this as one input among many — not as a sole basis for decisions. Proveground encourages equitable evaluation of all candidates.';
